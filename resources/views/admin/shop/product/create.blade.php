...
<section id="container" class="">
    ...
    @section('contents')
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading add">افزودن محصول</header>
                    <div class="panel-body" style="padding: 15px !important">
                        ...
                        @endif
                        <form role="form" class="form-horizontal tasi-form" method="POST" action="/admin/product"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2 red">بخش ها
                                        <span class="help-block" style=" font-size: 11px;color: #999;">انتشار همزمان در بخش های انتخاب شده</span>
                                    </label>
                                    <div class="col-lg-10">
                                        @foreach($sections as $section)
                                            @if($section->name != "نسخه های درمانی")
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10 checkbox-container" style="height: 640px;">
